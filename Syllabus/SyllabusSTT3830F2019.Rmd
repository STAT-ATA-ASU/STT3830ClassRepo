...
* 40% of the course grade will come from [DataCamp](https://www.datacamp.com/) assignments (4 assignments)

* 30% of the course grade will come from reproducing three [DataCamp](https://www.datacamp.com/) assignments with [bookdown](https://bookdown.org/yihui/bookdown/)

* 10% of the course grade will come from a predictive modeling competition

* 10% of the course grade will come from quizzes

* 10% of the course grade will come from the oral presentation where you discuss your final model used in the predictive modeling competition --- oral presentations will take place during the final exam period --- December 9, 2019, WA 303, 11-1:30pm
...
The [CoursePacing guide](../CoursePacing/CoursePacingSTT3840Fall2019.html) has all course assignments and due dates.
